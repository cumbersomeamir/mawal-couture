...
const products: ProductData[] = [
  ...
  // Winter Edit 2025/26 - Women
  {
    ...
    currency: 'USD',
    category: 'Pherans',
    collectionName: 'winter-edit-2025-26',
    gender: 'woman',
  ...
  // Festive Edit 2025/26 - Women
  {
    ...
    currency: 'USD',
    category: 'Pherans',
    collectionName: 'festive-edit-2025-26',
    gender: 'woman',
  ...
  // Vanguard Pherans - Men
  {
    ...
    currency: 'USD',
    category: 'Pherans',
    collectionName: 'vanguard-pherans',
    gender: 'man',
...
async function seed() {
  try {
    ...
    // List collections
    const collections = [...new Set(products.map(p => p.collectionName))];
